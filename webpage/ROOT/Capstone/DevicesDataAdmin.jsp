...
function validateForm() {
    ...
    if (deviceId == "") {
        alert("Device UID must be filled out");
        return false;
    }
}
</script>
...
<%
	...
	try{
			...
			//Call the showDeviceMonitor method. This method returns a ResultSet containing all the tuples in the table Device_Monitor
			ResultSet result = appDBAuth.showDeviceMonitor();
			
%>
<div style="margin-top: 20px;" id="buttonDiv">
    <button onclick="window.location.href='LowDangerAdmin.jsp'">Sort by Low Danger</button>
    <button onclick="window.location.href='MediumDangerAdmin.jsp'">Sort by Medium Danger</button>
    <button onclick="window.location.href='HighDangerAdmin.jsp'">Sort by High Danger</button>
</div>
...
<div style="margin-top: 20px;">
    <form action="SearchResultAdmin.jsp" method="post" onsubmit="return validateForm()">
